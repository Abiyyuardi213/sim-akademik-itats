...
<body class="h-screen w-full bg-white flex overflow-hidden">
        ...
        <div class="m-auto w-full max-w-[380px]">
            ...
            <div class="flex flex-col items-center space-y-3 mb-8">
                ...
                <div class="text-center space-y-1">
                    <h2 class="text-xl font-bold tracking-tight text-zinc-900">Login Guest</h2>
            ...
            <div class="bg-white rounded-[14px] border border-zinc-200 p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)]">
                <form action="{{ route('login.guest.post') }}" method="POST" class="space-y-4">
                    ...
                    <div class="flex items-center pt-1 pb-2">
                        ...
                        <label for="remember"
                            class="ml-2.5 block text-[13px] text-zinc-600 cursor-pointer select-none">Ingat saya</label>
                    </div>
    ...
    <div class="hidden lg:block lg:w-1/2 relative bg-zinc-900">
        <img src="{{ asset('image/d1.jpg') }}" alt="Background" class="absolute inset-0 w-full h-full object-cover">
