...
<head>
    ...
    <title>Ubah Data Peminjaman Ruangan</title>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ubah Data Peminjaman Ruangan</h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('keperluan_peminjaman') is-invalid @enderror"
                                                name="keperluan_peminjaman" required>{{ old('keperluan_peminjaman', $peminjaman->keperluan_peminjaman) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control @error('waktu_peminjaman') is-invalid @enderror"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control @error('waktu_berakhir_peminjaman') is-invalid @enderror"
                                                name="waktu_berakhir_peminjaman"
                                                value="{{ old('waktu_berakhir_peminjaman', $peminjaman->waktu_berakhir_peminjaman) }}" required>
