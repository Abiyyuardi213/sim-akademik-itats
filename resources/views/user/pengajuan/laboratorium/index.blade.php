...
<head>
    ...
    <title>Daftar Laboratorium | Akademik WR 1</title>
...
<body class="bg-white text-zinc-950 antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow container mx-auto px-4 md:px-6 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-zinc-900 mb-2">Daftar Laboratorium</h1>
            <p class="text-zinc-500">Pilih laboratorium yang sesuai dengan kebutuhan praktikum Anda.</p>
        </div>
        ...
        <div class="mb-6">
            <div class="relative max-w-sm">
                ...
                <input type="text" placeholder="Cari laboratorium..."
        ...
        @if (isset($gedungs)) <!-- Assuming variable is $gedungs -->
            <div class="space-y-12">
                @foreach ($gedungs as $gedung)
                    @if ($gedung->laboratorium->count() > 0)
                        <div class="space-y-4">
                            ...
                            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                @foreach ($gedung->laboratorium as $lab)
                                    <div
                                        ...
                                        <div class="aspect-video relative overflow-hidden bg-zinc-100">
                                            @if ($lab->gambar)
                                                <img src="{{ asset('uploads/laboratorium/' . $lab->gambar) }}"
                                                    alt="{{ $lab->nama_laboratorium }}"
                                        ...
                                        <div class="p-5">
                                            <h3 class="text-lg font-bold text-zinc-900 mb-1">
                                                {{ $lab->nama_laboratorium }}</h3>
                                            <p class="text-sm text-zinc-500 mb-4 line-clamp-2">
                                                {{ $lab->keterangan ?: 'Fasilitas praktikum lengkap.' }}</p>
                                            ...
                                            <div class="flex items-center justify-between mt-auto">
                                                ...
                                                <a href="{{ route('users.pengajuan.laboratorium.create', $lab->id) }}"
        ...
        @else
            ...
            <div class="text-center py-20 border-2 border-dashed border-zinc-200 rounded-xl">
                ...
                <h3 class="text-lg font-medium text-zinc-900">Tidak ada data laboratorium</h3>
