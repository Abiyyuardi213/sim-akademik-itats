        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="rounded-xl border border-zinc-200 bg-white shadow-sm overflow-hidden sticky top-8">
                    ...
                    <div class="aspect-video w-full bg-zinc-100 relative overflow-hidden">
                        @if ($laboratorium->gambar)
                            <img src="{{ asset('uploads/laboratorium/' . $laboratorium->gambar) }}"
                                alt="{{ $laboratorium->nama_laboratorium }}" class="w-full h-full object-cover">
                        @else
                    ...
                    <div class="p-6">
                        <h1 class="text-2xl font-bold text-zinc-900 mb-2">{{ $laboratorium->nama_laboratorium }}</h1>
                        <div class="flex items-center gap-2 text-zinc-500 text-sm mb-6">
                            <i class="fas fa-building text-zinc-400"></i>
                            <span>{{ $laboratorium->gedung->nama_gedung ?? 'Gedung tidak diketahui' }}</span>
                        </div>

                        <div class="space-y-4">
                            <div class="p-4 rounded-lg bg-zinc-50 border border-zinc-100">
                                <h3 class="text-sm font-semibold text-zinc-900 mb-2">Keterangan</h3>
                                <p class="text-sm text-zinc-600 leading-relaxed">
                                    {{ $laboratorium->keterangan ?: 'Tidak ada keterangan fasilitas.' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2">
                <div class="rounded-xl border border-zinc-200 bg-white shadow-sm p-6">
                    <div class="mb-6">
                        <h2 class="text-lg font-bold text-zinc-900">Jadwal Praktikum / Peminjaman</h2>
                        <p class="text-sm text-zinc-500">Pilih tanggal dan waktu untuk mengajukan peminjaman laboratorium.
                        </p>
                    </div>
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <form action="{{ route('users.pengajuan.laboratorium.store') }}" method="POST" class="p-4 sm:p-6">
                        @csrf
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="keperluan_peminjaman" id="keperluan_peminjaman" required rows="3"
                                    placeholder="Contoh: Praktikum Fisika Dasar, Penelitian Tugas Akhir"
