...
<head>
    ...
    <title>Akademik WR 1 - Pengajuan Peminjaman Support</title>
    ...
    <section id="beranda" class="hero-section">
        <div class="container">
            <div class="hero-content text-center fade-in">
                <h1 class="hero-title">Ajukan Peminjaman Gedung Support</h1>
                <p class="hero-subtitle">Temukan dan pinjam gedung support yang sesuai dengan kebutuhan Anda dengan mudah dan cepat melalui sistem terintegrasi kami.</p>
            </div>
        </div>
    </section>
    ...
    <section id="daftar-ruangan" class="py-5">
        <div class="container">
            <div class="text-center mb-5 fade-in">
                <h2 class="section-title">Daftar Gedung Support Tersedia</h2>
