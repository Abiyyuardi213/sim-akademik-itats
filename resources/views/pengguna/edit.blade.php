                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $pengguna->email) }}">
                                            @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                        </div>

                                        <div class="form-group">
                                            <label for="no_telepon">Nomor Telepon</label>
                                            <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" name="no_telepon" value="{{ old('no_telepon', $pengguna->no_telepon) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="role_id" id="role_id" class="form-control @error('role_id') is-invalid @enderror">
                                                ...
                                                @foreach($roles as $role)
                                                    <option value="{{ $role->id }}" {{ old('role_id', $pengguna->role_id) == $role->id ? 'selected' : '' }}>{{ $role->role_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4 text-center">
                                        ...
                                        <div style="width: 300px; height: 300px; border: 2px dashed #ccc; margin: auto; display: flex; align-items: center; justify-content: center;">
                                            <img id="preview" src="{{ $pengguna->profile_picture ? asset('storage/' . $pengguna->profile_picture) : 'https://via.placeholder.com/300x300?text=Preview' }}" class="img-fluid rounded" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                        </div>
                ...
                cropper = new Cropper(image, {
                    ...
                    crop(event) {
                        ...
                        canvas.toBlob((blob) => {
                            ...
                            // bisa dikirim ke backend jika perlu
                        });
                    }
                });
            };
