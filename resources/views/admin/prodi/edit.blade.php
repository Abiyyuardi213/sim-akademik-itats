...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 space-y-4 sm:space-y-0">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Ubah Program Studi</h1>
            <p class="mt-1 text-sm text-zinc-500">Perbarui informasi program studi.</p>
        </div>
    ...
    <div class="max-w-2xl bg-white rounded-xl border border-zinc-200 shadow-sm p-6 sm:p-8">
        <div class="mb-6 border-b border-zinc-100 pb-4">
            <h3 class="text-lg font-semibold text-zinc-900">Form Ubah Prodi</h3>
        ...
        <form action="{{ route('admin.prodi.update', $prodi->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="alias_prodi" name="alias_prodi"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="nip_kaprodi" name="nip_kaprodi"
                        value="{{ old('nip_kaprodi', $prodi->nip_kaprodi) }}"
                        class="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950">
                </div>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea id="prodi_description" name="prodi_description" rows="4"
                    class="flex min-h-[80px] w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950">{{ old('prodi_description', $prodi->prodi_description) }}</textarea>
            </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <select id="prodi_status" name="prodi_status" required
                        ...
                        <option value="1" {{ old('prodi_status', $prodi->prodi_status) == '1' ? 'selected' : '' }}>
                            Aktif</option>
                        <option value="0" {{ old('prodi_status', $prodi->prodi_status) == '0' ? 'selected' : '' }}>
                            Nonaktif</option>
                    </select>
