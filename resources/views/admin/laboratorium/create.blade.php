...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 space-y-4 sm:space-y-0">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Tambah Laboratorium</h1>
            <p class="mt-1 text-sm text-zinc-500">Tambahkan data laboratorium dan fasilitas praktikum baru.</p>
        </div>
    ...
    <div class="max-w-4xl bg-white rounded-xl border border-zinc-200 shadow-sm p-6 sm:p-8">
        <div class="mb-6 border-b border-zinc-100 pb-4">
            <h3 class="text-lg font-semibold text-zinc-900">Form Data Laboratorium</h3>
            <p class="text-sm text-zinc-500">Lengkapi informasi laboratorium dan kapasitas.</p>
        </div>
