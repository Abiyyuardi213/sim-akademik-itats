...
return new class extends Migration
{
    ...
    {
        Schema::create('pengajuan_peminjaman_laboratorium', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->foreignUuid('user_id')->constrained('users')->onDelete('cascade');
            $table->foreignUuid('laboratorium_id')->constrained('laboratorium')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pengajuan_peminjaman_laboratorium');
    }
};
